...
public class Actualite {
    ...
    public Actualite(String titre, String message, String date, String imageRef) {
    ...
    public Actualite jsonToActualite(String json){
    ...
    public Actualite get(Context context, int _idactualite){
        Actualite actualite = null;
        try{
            Database db = new Database(context);
    ...
    public ArrayList<Actualite> getAll(Context context){
